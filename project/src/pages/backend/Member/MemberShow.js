            ...
            <div className="card-header">
                <div className="row">
                    ...
                    <div className="col-6 text-end">
                        <Link className="btn btn-sm btn-primary me-1" to={"/admin/member/update/" + user.id}>
                            <FontAwesomeIcon icon={faEdit} />
                            Sửa</Link>
                        <button
                            className="btn btn-sm btn-danger "
                            onClick={() => {
                                if (window.confirm("Bạn có chắc muốn xóa thanh vien  này không?"))
                                    deleteUser(user.id);
                            }}
                        >
                            <FontAwesomeIcon icon={faTrash} />
                        </button>                        <Link to="/admin/member" className="btn btn-sm btn-info">
